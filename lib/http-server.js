...
function HttpServer(options) {
  ...
  if(options.showDir)
    this.showDir = options.showDir.toLowerCase() !== 'false';
  if(options.autoIndex)
    this.autoIndex = options.autoIndex.toLowerCase() !== 'false';
  if(options.showDotfiles)
    this.showDotfiles = options.showDotfiles.toLowerCase() !== 'false';
  if(options.gzip)
    this.gzip = options.gzip.toLowerCase() !== 'false';
  if(options.brotli)
    this.brotli = options.brotli.toLowerCase() !== 'false';
  if (options.ext) {
    this.ext = options.ext.toLowerCase() !== 'false'
      ? 'html'
      : options.ext;
  }
