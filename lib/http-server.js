...
function HttpServer(options) {
  ...
  if (options.cors) {
    ...
    this.headers['Access-Control-Allow-Headers'] = 'Origin, X-Requested-With, Content-Type, Accept, Range, Accept-Ranges';
    this.headers['Access-Control-Expose-Headers'] = 'Origin, X-Requested-With, Content-Type, Accept, Range, Accept-Ranges';
